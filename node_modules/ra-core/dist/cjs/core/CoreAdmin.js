...
var CoreAdmin = function (props) {
    ...
    ready = props.ready, requireAuth = props.requireAuth, _a = props.title, title = _a === void 0 ? 'React Admin' : _a;
    return (React.createElement(CoreAdminContext_1.CoreAdminContext, { authProvider: authProvider, basename: basename, dataProvider: dataProvider, i18nProvider: i18nProvider, queryClient: queryClient, history: history },
