...
var useListController = function (props) {
    ...
    var disableAuthentication = props.disableAuthentication, _a = props.exporter, exporter = _a === void 0 ? export_1.defaultExporter : _a, filterDefaultValues = props.filterDefaultValues, _b = props.sort, sort = _b === void 0 ? defaultSort : _b, _c = props.perPage, perPage = _c === void 0 ? 10 : _c, filter = props.filter, _d = props.debounce, debounce = _d === void 0 ? 500 : _d, disableSyncWithLocation = props.disableSyncWithLocation, _e = props.queryOptions, queryOptions = _e === void 0 ? {} : _e;
