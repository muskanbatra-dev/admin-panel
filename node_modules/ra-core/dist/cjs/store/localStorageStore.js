 ...
 * );
 */
var localStorageStore = function (version) {
    ...
    return {
        setup: function () {
            if (localStorageAvailable) {
                var storedVersion = (0, exports.getStorage)().getItem("".concat(RA_STORE, ".version"));
                if (storedVersion && storedVersion !== version) {
                    (0, exports.getStorage)().clear();
                }
                (0, exports.getStorage)().setItem("".concat(RA_STORE, ".version"), version);
        ...
        getItem: function (key, defaultValue) {
            var valueFromStorage = (0, exports.getStorage)().getItem("".concat(RA_STORE, ".").concat(key));
            // eslint-disable-next-line eqeqeq
        ...
        setItem: function (key, value) {
            if (value === undefined) {
                (0, exports.getStorage)().removeItem("".concat(RA_STORE, ".").concat(key));
            }
            else {
                (0, exports.getStorage)().setItem("".concat(RA_STORE, ".").concat(key), JSON.stringify(value));
            }
            publish(key, value);
        },
