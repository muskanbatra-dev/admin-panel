...
exports.getSimpleValidationResolver = exports.flattenErrors = void 0;
var lodash_1 = __importDefault(require("lodash"));
// Flattening an object into path keys:
// https://github.com/lodash/lodash/issues/2240#issuecomment-418820848
var flattenErrors = function (obj, path) {
    var _a;
    if (path === void 0) { path = []; }
    return !lodash_1.default.isObject(obj)
        ? (_a = {}, _a[path.join('.')] = obj, _a) : lodash_1.default.reduce(obj, function (cum, next, key) {
        var _a;
        if (obj[key].message !=
            null &&
            obj[key].args != null) {
            return lodash_1.default.merge(cum, (_a = {}, _a[key] = obj[key], _a));
        }
        return lodash_1.default.merge(cum, (0, exports.flattenErrors)(next, __spreadArray(__spreadArray([], path, true), [key], false)));
    }, {});
};
 ...
 * );
 */
var getSimpleValidationResolver = function (validate) { return function (data) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                flattenedErrors = (0, exports.flattenErrors)(errors);
                return [2 /*return*/, {
                        values: {},
...
exports.getSimpleValidationResolver = getSimpleValidationResolver;
