...
var useSuggestions = function (_a) {
    var allowCreate = _a.allowCreate, choices = _a.choices, _b = _a.createText, createText = _b === void 0 ? 'ra.action.create' : _b, _c = _a.createValue, createValue = _c === void 0 ? '@@create' : _c, _d = _a.emptyText, emptyText = _d === void 0 ? '' : _d, _e = _a.emptyValue, emptyValue = _e === void 0 ? null : _e, limitChoicesToValue = _a.limitChoicesToValue, matchSuggestion = _a.matchSuggestion, optionText = _a.optionText, optionValue = _a.optionValue, selectedItem = _a.selectedItem, _f = _a.suggestionLimit, suggestionLimit = _f === void 0 ? 0 : _f, translateChoice = _a.translateChoice;
    var translate = (0, i18n_1.useTranslate)();
    var _g = (0, useChoices_1.useChoices)({
...
var getSuggestionsFactory = function (_a) {
    var _b = _a.allowCreate, allowCreate = _b === void 0 ? false : _b, _c = _a.choices, choices = _c === void 0 ? [] : _c, _d = _a.createText, createText = _d === void 0 ? 'ra.action.create' : _d, _e = _a.createValue, createValue = _e === void 0 ? '@@create' : _e, _f = _a.emptyText, emptyText = _f === void 0 ? '' : _f, _g = _a.emptyValue, emptyValue = _g === void 0 ? null : _g, _h = _a.optionText, optionText = _h === void 0 ? 'name' : _h, _j = _a.optionValue, optionValue = _j === void 0 ? 'id' : _j, getChoiceText = _a.getChoiceText, getChoiceValue = _a.getChoiceValue, _k = _a.limitChoicesToValue, limitChoicesToValue = _k === void 0 ? false : _k, _l = _a.matchSuggestion, matchSuggestion = _l === void 0 ? defaultMatchSuggestion(getChoiceText) : _l, selectedItem = _a.selectedItem, _m = _a.suggestionLimit, suggestionLimit = _m === void 0 ? 0 : _m;
