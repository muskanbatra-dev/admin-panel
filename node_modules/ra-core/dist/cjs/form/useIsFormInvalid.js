...
exports.useIsFormInvalid = void 0;
 ...
 */
var useIsFormInvalid = function (control) {
    var _a = (0, react_1.useState)(false), isInvalid = _a[0], setIsInvalid = _a[1];
    var _b = (0, react_hook_form_1.useFormState)(control ? { control: control } : undefined), isValid = _b.isValid, submitCount = _b.submitCount, errors = _b.errors;
...
exports.useIsFormInvalid = useIsFormInvalid;
