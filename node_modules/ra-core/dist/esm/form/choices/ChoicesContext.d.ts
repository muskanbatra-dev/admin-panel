 ...
 */
export declare const ChoicesContext: import("react").Context<ChoicesContextValue<any>>;
export declare type ChoicesContextValue<RecordType extends RaRecord = any> = {
